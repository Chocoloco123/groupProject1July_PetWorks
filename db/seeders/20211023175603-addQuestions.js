...
module.exports = {
  up: (queryInterface, Sequelize) => {
   ...
   return queryInterface.bulkInsert('Questions', [
     ...
     {userId: 3, question: 'Will dogs eat squirrels?', category: 'misc', petType: 'dog', createdAt: '2017-11-30', updatedAt: '2018-01-22'},
     ...
     {userId: 4, question: 'When is the best time to introduce your new cat to your pets?', category: 'socialization', petType: 'cat', createdAt: '2021-01-30', updatedAt: '2021-02-14'},
     ...
     {userId: 5, question: 'How to clean a fish tank?', category: 'health', petType: 'other', createdAt: '2020-06-30', updatedAt: '2020-07-22'},
